...
bota.push(new Producto('Botas Cinnamon', 3, '$18.260', 'Negro', '46', 40));

texana.push(new Producto('Texanas Apola', 4, '$6.300', 'Blanco', '46', 15));
texana.push(new Producto('Texanas Aria', 5, '$12.900', 'Negro', '46', 22));
texana.push(new Producto('Texanas Shirp', 6, '$13.800', 'Blanco', '45', 30));

borcego.push(new Producto('Borcegos Beta', 7, '$9.999', 'Negro', '45', 21));
borcego.push(new Producto('Borcegos Genesis', 8, '$15.480', 'Blanco', '46', 30));
